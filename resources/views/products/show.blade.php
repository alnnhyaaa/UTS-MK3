...
@section('tabel')
    ...
    <div class="row">
        <div class="col mb-3">
            ...
            <input type="text" name="title" class="form-control" placeholder="Kendaraan" value="{{ $product->title }}" readonly>
        </div>
        <div class="col mb-3">
    ...
    <div class="row">
        ...
        <div class="col mb-3">
            ...
            <textarea class="form-control" name="description" placeholder="Ruangan Pasien" readonly>{{ $product->description }}</textarea>
        </div>
    </div>
    <div class="row">
        <div class="col mb-3">
